...
<body>
        ...
        <header>
            <div class="image-text">
                ...
                <div class="text logo-text">
                    ...
                    <span class="descripcion">Official website RFAF</span>
                </div>
            </div>
    ...
    <div class="container table-responsive">
        ...
        <table class="table" id="tableAdmins">
            <thead>
                <th>Id</th>
                <th>Name</th>
                <th>Mail</th>
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal" method="POST">
                    <fieldset>
                        <legend class="text-center header">Edit user</legend>

                        <div class="form-group mt-4">
                            <div class="col-md-8">
                                <input id="idAd" name="idAd" type="text" placeholder="ID" class="form-control" autocomplete="off">
                            </div>
                        </div>

                        <div class="form-group mt-4">
                            <div class="col-md-8">
                                <input id="nombre" name="nombre" type="text" placeholder="Nombre completo" class="form-control" autocomplete="off">
                            </div>
                        </div>

                        <div class="form-group mt-4">
                            <div class="col-md-8">
                                <input id="mail" name="mail" type="email" placeholder="Mail" class="form-control" autocomplete="off">
                            </div>
                        </div>
    ...
    <script src="librerias/jquery-ui-1.13.1/jquery-ui.min.js"></script>
    ...
    <script src="js/editDeleteAdmin.js"></script>
</body>
